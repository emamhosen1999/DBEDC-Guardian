...
<head>
    ...
    <meta http-equiv="Content-Security-Policy" content="
        default-src 'self';
        script-src 'self' 'unsafe-inline' 'unsafe-eval' https://fonts.googleapis.com https://fonts.gstatic.com https://translate.google.com http://localhost:5173 https://aero-enterprise-suite.test:5173;
        style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://fonts.gstatic.com;
        img-src 'self' data: https: blob:;
        font-src 'self' https://fonts.googleapis.com https://fonts.gstatic.com;
        connect-src 'self' https://fonts.googleapis.com https://translate.google.com http://localhost:5173 https://aero-enterprise-suite.test:5173 ws://localhost:5173 ws://aero-enterprise-suite.test:5173;
        media-src 'self';
        object-src 'none';
        base-uri 'self';
        form-action 'self';
    ...
    <link rel="mask-icon" href="<?php echo e(asset('assets/images/safari-pinned-tab.svg')); ?>" color="#134e9d">
    ...
    <div id="app-loading" aria-label="Loading application">
        <div class="loading-content">
            ...
            <div class="loading-logo">
                <img src="<?php echo e(asset('assets/images/logo.png')); ?>" alt="Logo" style="width: 80px; height: 80px; object-fit: contain; border-radius: 12px;" 
            ...
            showLoading: function(message = 'Loading...', subtitle = 'Please wait...') {
                ...
                if (!loading) {
                    ...
                    loading.innerHTML = `
                        <div class="loading-content">
                            <div class="loading-logo">
                                <img src="<?php echo e(asset('assets/images/logo.png')); ?>" alt="Logo" style="width: 160px; height: 160px; object-fit: contain; border-radius: 12px;" 
                                     onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
...
</html><?php /**PATH C:\laragon\www\Aero-Enterprise-Suite\resources\views/app.blade.php ENDPATH**/ ?>