...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/nebula-glass.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/nebula-showcase.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/nebula-components.css') }}">
