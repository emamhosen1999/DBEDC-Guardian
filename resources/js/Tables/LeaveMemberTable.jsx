...
const LeaveMemberTable = React.forwardRef(({
    leaves,
    allUsers,
    handleClickOpen,
    setCurrentLeave,
    ...
    const columns = [
        ...(isAdminView ? [{ name: "Member", uid: "employee", icon: UserIcon }] : []),
...
LeaveMemberTable.displayName = 'LeaveMemberTable';

export default LeaveMemberTable;