    ...
    useEffect(() => {
        ...
        const fetchChartData = async () => {
            try {
                ...
                const response = await axios.get(route('admin.dashboard.attendance-trends'), {
                ...
                <div className="flex items-center justify-between w-full">
                    ...
                    <div className="flex items-center gap-4 text-xs">
                        <div className="flex items-center gap-1">
                            ...
                            />
                            <span style={{ color: themeColors.foreground400 }}>Present</span>
                        </div>
                        <div className="flex items-center gap-1">
                            <div 
                                className="w-3 h-3 rounded-full"
                            ...
                            />
                            <span style={{ color: themeColors.foreground400 }}>Absent</span>
                        </div>
                    </div>
                </div>
            </CardHeader>
                ...
                {chartData.length === 0 ? (
                    <div className="flex items-center justify-center h-48">
                        <div className="text-center">
                            ...
                            <p className="text-sm" style={{ color: themeColors.foreground400 }}>
