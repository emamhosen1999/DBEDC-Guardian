        ...
        <App>
            ...
            <div className="mx-auto w-full max-w-4xl space-y-6 p-4 sm:p-6">
                <div>
                    ...
                    <p className="text-sm text-gray-600">Register a new skill in the system.</p>
                </div>
                ...
                <form onSubmit={submit} className="space-y-4 rounded-lg border border-gray-200 bg-white p-4 sm:p-6">
                    <div className="grid gap-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="text" value={data.category} onChange={(e) => setData('category', e.target.value)} className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm" placeholder="e.g., Technical, Soft Skills" />
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" value={data.required_for_roles} onChange={(e) => setData('required_for_roles', e.target.value)} className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm" placeholder="Comma-separated role names" />
                        </div>
                    </div>
