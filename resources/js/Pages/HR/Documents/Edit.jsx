...
export default function EditDocuments({ document }) {
    const { data, setData, post, processing, errors } = useForm({
        name: document?.name || '',
        category: document?.category || '',
        file: null,
        description: document?.description || '',
        access_level: document?.access_level || 'private',
        _method: 'PUT',
    });
    ...
    return (
        <App>
            ...
            <div className="mx-auto w-full max-w-4xl space-y-6 p-4 sm:p-6">
                <div>
                    <h1 className="text-2xl font-semibold text-gray-900">Edit HR Document</h1>
                ...
                <form onSubmit={submit} className="space-y-4 rounded-lg border border-gray-200 bg-white p-4 sm:p-6">
                    <div className="grid gap-4 sm:grid-cols-2">
                        ...
                        <div className="sm:col-span-2">
                            <label className="mb-1 block text-sm font-medium text-gray-700">Upload New File (Optional)</label>
