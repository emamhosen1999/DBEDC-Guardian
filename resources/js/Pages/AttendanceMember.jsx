...
import AttendanceMemberTable from "@/Tables/AttendanceMemberTable.jsx";
import { 
  ClockIcon, 
  CalendarDaysIcon,
  ChartBarIcon,
...
const AttendanceMember = React.memo(({ title, totalWorkingDays, presentDays, absentDays, lateArrivals }) => {
...
AttendanceMember.layout = (page) => <App>{page}</App>;
