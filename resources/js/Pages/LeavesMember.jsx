...
const LeavesMember = ({ title, allUsers }) => {
 ...
 // Memoized year options
  ...
  const leaveMatchesFilters = useCallback((leave) => {
    ...
    // Member filter (for future extensibility, currently always own)
    if (filters.employee) {
...
LeavesMember.layout = (page) => <App>{page}</App>;

export default LeavesMember;