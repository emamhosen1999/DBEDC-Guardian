...
import MemberTable from "@/Tables/MemberTable.jsx";
...
const WorkForceList = ({ title, departments, designations, attendanceTypes }) => {
  ...
  const [employees, setWorkForce] = useState([]);
  ...
  const fetchWorkForce = useCallback(async () => {
    ...
    try {
      ...
      setWorkForce(data.employees.data);
  ...
  // Optimistic updates
  const updateMemberOptimized = useCallback((id, updatedFields) => {
    setWorkForce(prev => 
      prev.map(employee => 
  ...
  const deleteMemberOptimized = useCallback((id) => {
    setWorkForce(prev => prev.filter(employee => employee.id !== id));
  ...
  return (
    <>
      <Head title={title || "Member Directory"} />
      <div 
        className="flex flex-col w-full h-full p-4"
        role="main"
        aria-label="Member Directory Management"
      >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                  ...
                  <div className="bg-white/5 backdrop-blur-md rounded-lg border border-white/10 p-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-default-600">Active WorkForce</span>
                ...
                >
                  ...
                  <CardBody>
                    <div className="max-h-[84vh] overflow-y-auto">
                      ...
                      loading={loading}
                      updateMemberOptimized={updateMemberOptimized}
                      deleteMemberOptimized={deleteMemberOptimized}
                    />
                  ) : (
                    <div className="p-4">
                      {employees.length > 0 ? (
...
WorkForceList.layout = (page) => <App>{page}</App>;
