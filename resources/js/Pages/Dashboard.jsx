        ...
        <>
            ...
            <Flex direction="column" gap={{ initial: '3', sm: '4' }} p={{ initial: '3', sm: '4', md: '5' }}>
                ...
                <Grid columns={{ initial: '1', md: '12' }} gap={{ initial: '3', md: '4' }}>
                    ...
                    <Box style={{ gridColumn: 'span 1', height: '100%', display: 'flex', flexDirection: 'column' }} className="md-col-span-6">
                        <GreetingBanner user={auth.user} />
                    </Box>
                    <Box style={{ gridColumn: 'span 1', height: '100%', display: 'flex', flexDirection: 'column' }} className="md-col-span-3">
                        <ClockWidget />
                    </Box>
                    <Box style={{ gridColumn: 'span 1', height: '100%', display: 'flex', flexDirection: 'column' }} className="md-col-span-3">
                        <WeatherWidget />
                    ...
                    {hasAll(['attendance.own.punch', 'attendance.own.view']) && (
                        <Box style={{ gridColumn: 'span 1', height: '100%', display: 'flex', flexDirection: 'column' }} className="md-col-span-4">
                            <ErrorBoundary>
                    ...
                    {hasAny(['attendance.own.view', 'attendance.view']) && (
                        <Box style={{ gridColumn: 'span 1', height: '100%', display: 'flex', flexDirection: 'column' }} className="md-col-span-8">
                            <ErrorBoundary>
                    ...
                    <Flex direction="column" gap="2" style={{ gridColumn: 'span 1', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }} className="md-col-span-4">
                        <ErrorBoundary>
